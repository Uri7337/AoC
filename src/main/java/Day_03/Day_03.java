...
public class Day_03{
    ...
    public static void main(String[] args) {
        ...
        String filepath_my_test = "./src/main/resources/Day_03_test_2017_1.txt";
        String filepath_test = "./src/main/resources/Day_03_test_2017.txt";
		String filepath = "./src/main/resources/Day_03_2017.txt";
        ...
        if(part1){
            ...
            if (mytest) {
             ...
             if(tests){
                ...
                if(Long.valueOf(sol1_test) == 31){ep.p(" | OK: True");}else{ep.p(" | OK: False");}
             }
