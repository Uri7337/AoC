...
public class CreateDay {
  ...
  //Solution_1_Day_##.java
    try {
            ...
            writer.newLine();
            writer.write("\t\tString filepath = \"/home/deadpool7337/UriPrograms/Other/AoC/PuzzleInputs/Day_" + dayNum + "_test_2016.txt\";");
            writer.newLine();
            writer.write("\t\t//String filepath = \"/home/deadpool7337/UriPrograms/Other/AoC/PuzzleInputs/Day_" + dayNum + "_2016.txt\";");
            writer.newLine();
