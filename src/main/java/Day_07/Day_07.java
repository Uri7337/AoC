...
public class Day_07 {
    ...
    public static void main(String[] args) {
        ...
        String filepath_my_test = "./src/main/resources/Day_07_test_2021_1.txt";
        String filepath_test = "./src/main/resources/Day_07_test_2021.txt";
		String filepath = "./src/main/resources/Day_07_2021.txt";
