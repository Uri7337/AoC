...
public class Day_07 {
    ...
    public static void main(String[] args) {
        ...
        String filepath_my_test = "./src/main/resources/Day_07_test_2017_1.txt";
        String filepath_test = "./src/main/resources/Day_07_test_2017.txt";
		String filepath = "./src/main/resources/Day_07_2017.txt";
